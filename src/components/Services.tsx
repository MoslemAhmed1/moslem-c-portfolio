...
const Services = () => {
  ...
  return <section id="services" className="py-24 bg-gradient-to-b from-secondary/30 to-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">From network intrusion detection to algorithm visualization—showcasing practical applications of data analysis and machine learning, turning datasets into clear insights and measurable results.</p>
        </div>

        {/* Services Grid */}
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {services.map((service, index) => <Card key={index} className="p-6 shadow-card hover:shadow-elevated transition-smooth border-tech/10">
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    {service.technologies.map((tech, idx) => <Badge key={idx} variant="secondary" className="text-xs bg-secondary/80">
                        {tech}
                      </Badge>)}
                  </div>
        ...
        <div className="mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {engagementTypes.map((type, index) => <Card key={index} className={`p-6 border-2 ${type.color} hover:scale-105 transition-smooth`}>
